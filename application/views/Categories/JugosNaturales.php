  ...
  <nav class="navbar navbar-dark bg-dark fixed-top">
      <div class="container-fluid">
        ...
        <div class="container-titulo text-center text-white">
              <h2 class="color-cat-13">Jugos Naturales<i class=" fas fa-carrot"></i></h2>
            </div>
...
<script src="https://app.comeya.xyz/application/assets/js/FuntionsJugosNaturales.js"></script>
