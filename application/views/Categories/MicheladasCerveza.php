  ...
  <nav class="navbar navbar-dark bg-dark fixed-top">
      <div class="container-fluid">
        ...
        <div class="container-titulo text-center text-white">
              <h2 class="color-cat-15">Micheladas de Cerveza<i class="fas fa-cocktail"></i></h2>
            </div>
...
<script src="https://app.comeya.xyz/application/assets/js/FuntionsMicheladasCerveza.js"></script>
