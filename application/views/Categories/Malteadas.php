...
<head>
    ...
    <title>Galvis Cafe - Malteadas</title>
    <!-- Favi icon -->
  ...
  <nav class="navbar navbar-dark bg-dark fixed-top">
      <div class="container-fluid">
        ...
        <div class="container-titulo text-center text-white">
              <h2 class="color-cat-5">Malteadas<i class="fas fa-glass-martini"></i></h2>
            </div>
...
<script src="https://app.comeya.xyz/application/assets/js/FuntionsMalteadas.js"></script>
