  ...
  <nav class="navbar navbar-dark bg-dark fixed-top">
      <div class="container-fluid">
        ...
        <div class="container-titulo text-center text-white">
              <h2 class="color-cat-14">Aromaticas<i class="fas fa-leaf"></i></h2>
            </div>
    ...
    </nav>  <div class="container-top"></div>
...
<script src="https://app.comeya.xyz/application/assets/js/FuntionsAromaticas.js"></script>
