...
<head>
    ...
    <title>Galvis Cafe - Cerveza</title>
    <!-- Favi icon -->
  ...
  <nav class="navbar navbar-dark bg-dark fixed-top">
      <div class="container-fluid">
        ...
        <div class="container-titulo text-center text-white">
              <h2 class="color-cat-12">Cerveza<i class=" fas fa-beer"></i></h2>
            </div>
...
<script src="https://app.comeya.xyz/application/assets/js/FuntionsCerveza.js"></script>
