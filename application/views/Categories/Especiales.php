...
<head>
    ...
    <title>Galvis Cafe - Especiales</title>
    <!-- Favi icon -->
      ...
      <div class="container-fluid">
        ...
        <a href="https://app.comeya.xyz">
            ...
            <div class="container-titulo text-center text-white">
              <h2 class="color-cat-1">Especiales<i class="fas fa-star"></i></h2>
            </div>
...
<script src="https://app.comeya.xyz/application/assets/js/FuntionsEspeciales.js"></script>
