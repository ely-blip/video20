...
<head>
    ...
    <title>Galvis Cafe - Nevados</title>
    <!-- Favi icon -->
  ...
  <nav class="navbar navbar-dark bg-dark fixed-top">
      <div class="container-fluid">
        ...
        <div class="container-titulo text-center text-white">
              <h2 class="color-cat-4">Nevados<i class="fas fa-snowflake"></i></h2>
            </div>
...
<script src="https://app.comeya.xyz/application/assets/js/FuntionsNevados.js"></script>
