...
<head>
    ...
    <title>Galvis Cafe - Cholados</title>
    <!-- Favi icon -->
  ...
  <nav class="navbar navbar-dark bg-dark fixed-top">
      <div class="container-fluid">
        ...
        <div class="container-titulo text-center text-white">
              <h2 class="color-cat-3">Cholados<i class="fas fa-glass-whiskey"></i></h2>
            </div>
...
<script src="https://app.comeya.xyz/application/assets/js/FuntionsCholados.js"></script>
