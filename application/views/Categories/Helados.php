...
<head>
    ...
    <title>Galvis Cafe - Helados</title>
    <!-- Favi icon -->
  ...
  <nav class="navbar navbar-dark bg-dark fixed-top">
      <div class="container-fluid">
        ...
        <div class="container-titulo text-center text-white">
              <h2 class="color-cat-2">Helados <i class="fas fa-ice-cream"></i></h2>
            </div>
...
<script src="https://app.comeya.xyz/application/assets/js/FuntionsHelados.js"></script>
