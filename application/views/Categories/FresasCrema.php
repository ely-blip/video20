...
<head>
    ...
    <title>Galvis Cafe - Fresas con Crema</title>
    <!-- Favi icon -->
  ...
  <nav class="navbar navbar-dark bg-dark fixed-top">
      <div class="container-fluid">
        ...
        <div class="container-titulo text-center text-white">
              <h2 class="color-cat-10">Fresas con Crema<i class=" fas bi bi-cup-straw"></i></h2>
            </div>
...
<script src="https://app.comeya.xyz/application/assets/js/FuntionsFresasCrema.js"></script>
